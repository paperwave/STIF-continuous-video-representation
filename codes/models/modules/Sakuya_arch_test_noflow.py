...
class LunaTokis(nn.Module):
    def __init__(self, nf=64, nframes=3, groups=8, front_RBs=5, back_RBs=10):
        ...
        self.feat_imnet = Siren(in_features=201, out_features=3, hidden_features=[64, 64, 256, 256, 256], 
                  hidden_layers=4, outermost_linear=True)
        # self.flow_imnet = Siren(in_features=128+1+192+6, out_features=4, hidden_features=[64, 64, 64, 256], 
        #           hidden_layers=3, outermost_linear=True)
        # self.encode_imnet = Siren(in_features=13+128*2+192*2, out_features=3, hidden_features=[64, 64, 256, 256], 
        #           hidden_layers=3, outermost_linear=True)
    ...
    def decoding(self, times=None, scale=None):
        ...
        for c in range(len(times)):
            ...
            pred = self.feat_imnet(inp.view(bs * qs, -1)).view(bs, qs, -1)
